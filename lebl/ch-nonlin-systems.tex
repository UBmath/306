...
{\color{white} TEXT TO FORCE PAGE BREAK}
\vskip 4in
\newpage % to force Python addition all on to the next page
...
$(x,x^\prime)=(2,3)$ and $(x,x^\prime)=(2,2.9)$, and also the solutions in the $(x,t)$ space.  The two
...
\includegraphics[width=6.24in]{additional_figures/duffing_two_separating_trajectories.png}
