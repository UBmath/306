...
solutions as $t$ increases\index{stable critical point}.
In fact in this simple example if we change the initial condition a little bit, then as 
$t \to \infty$ we get $x(t) \to A$.  
...
%as $t \to \infty$.  
If a critical point is not stable, we say it is
...
% 1.9 First order linear PDE OMITTED FROM UB EDITION 2   1/9/2020
