		...
		if sectionname in a1:
			...
			if 'additions_at_end_of_section' in sectionadditions:
				for endofsectionaddition in sectionadditions['additions_at_end_of_section']:
					mergedtext += endofsectionaddition

			mergedtext += section['exercises_without_answers']
			mergedtext += '\n\n\setcounter{exercise}{50}\n\n'
			mergedtext += '\n\n'.join(sectionadditions['exercises_without_answers'])

			mergedtext += section['exercises_with_answers']
			mergedtext += '\n\n\setcounter{exercise}{150}\n\n'
			mergedtext += '\n\n'.join(sectionadditions['exercises_with_answers'])
...
print('\nRunning pdflatex. You may need to hit Enter a few times to get pdflatex to complete.')
